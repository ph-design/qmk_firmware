...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_multi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, LT(1, KC_GUI), KC_APP,  KC_RCTL
    ),
    ...
    [1] = LAYOUT_60_multi(
        ...
        KC_TAB , _______, KC_UP,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
